            ...
            <div class="col-lg-8 col-12">
              <div class="box-konten small-box">
                <div class="inner d-flex flex-column flex-lg-row">
                  ...
                  <div class="tulisan-konten-guru">
                      <h2 class="font">SMKN 10 SURABAYA</h2>
                      <p class="deskripsi-konten-guru">Selamat datang di aplikasi absensi siswa SMKN 10 Surabaya!, Aplikasi ini dibuat khusus untuk mempermudah dalam absensi siswa dan mengelola data absensi siswa serta merekap data absensi.</p>
                  </div>
                </div>
              </div>
            </div>
