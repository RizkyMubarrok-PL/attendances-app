...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Comfortaa:wght@300..700&family=Edu+AU+VIC+WA+NT+Pre:wght@400..700&display=swap" rel="stylesheet">
            ...
            <form>
                ...
                <div class="input-container">
                    ...
                    <span class="toggle-password" onclick="togglePassword()">
                        <img id="toggleIcon" src="img/eye-closed.png" alt="Toggle Password" style="cursor: pointer; width: 24px;">
                    </span> 
                </div>
